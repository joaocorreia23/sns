                            ...
                            render: (data, type, row) => {
                                return `
									<div>
                                        ...
                                        <button type="button" data-id="${row.hashed_id}" data-name="${row.email}" data-datatable-action="delete-row" class="btn btn-icon btn-bg-light btn-color-danger btn-active-light-danger rounded w-35px h-35px"><i class="ki-outline ki-information-2 fs-2"></i></button>
                                        <button type="button" data-id="${row.hashed_id}" data-name="${row.email}" data-datatable-action="delete-row" class="btn btn-icon btn-bg-light btn-color-danger btn-active-light-danger rounded w-35px h-35px"><i class="ki-outline ki-check-circle fs-2"></i></button>
										<button type="button" data-id="${row.hashed_id}" data-name="${row.email}" data-datatable-action="delete-row" class="btn btn-icon btn-bg-light btn-color-danger btn-active-light-danger rounded w-35px h-35px"><i class="ki-outline ki-information-3 fs-2"></i></button>
										<button type="button" data-id="${row.hashed_id}" data-name="${row.email}" data-datatable-action="delete-row" class="btn btn-icon btn-bg-light btn-color-danger btn-active-light-danger rounded w-35px h-35px"><i class="ki-outline ki-calendar-remove fs-2"></i></button>
