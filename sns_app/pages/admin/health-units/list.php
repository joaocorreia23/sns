...
<?php $page_name = "Listagem de Unidades de Saúde" ?>
        ...
        var datatableServerSide = (function() {
            ...
            var initDatatable = () => {
                dt = $("#datatable").DataTable({
                    ...
                    stateSave: false,
                    ajax: {
                        url: "http://localhost:3000/api/health_unit/table",
                        type: "GET",
                    },
                    columns: [{
                            data: "name"
                    ...
                    columnDefs: [{
                        ...
                        },
                        {
                            ...
                            <div>
                                ...
                                <button type="button" data-id="${row.hashed_id}" data-name="${row.name}" data-datatable-action="delete-row" class="btn btn-icon btn-bg-light btn-color-danger btn-active-light-danger rounded w-35px h-35px"><i class="ki-outline ki-trash fs-2"></i></button>
                            </div>
                        `
                            },
                        },
            ...
            var handleDeleteRows = () => {
                ...
                $("#datatable").on("click", "[data-datatable-action='delete-row']", (e) => {
                    ...
                    Swal.fire({
                        icon: "warning",
                        title: "Desativar Unidade de Saúde",
                        text: "Tem a certeza que deseja desativar a Unidade de Saúde (" + name + ") ?",
                        ...
                        if (result.isConfirmed) {
                            ...
                            fetch("http://localhost:3000/api/health_unit/deactivate", options)
                                .then((response) => {
